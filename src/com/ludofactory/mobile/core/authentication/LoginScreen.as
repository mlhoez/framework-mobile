...
package com.ludofactory.mobile.core.authentication
{
	...
	public class LoginScreen extends AdvancedScreen
	{
		...
		override protected function initialize():void
		{
			...
			_headerTitle = Localizer.getInstance().translate("LOGIN.HEADER_TITLE");
			...
			_retreivePasswordLink.label = Localizer.getInstance().translate("LOGIN.FORGOT_PASSWORD");
			_retreivePasswordLink.nameList.add( Theme.BUTTON_EMPTY );
...
//	Validation
		...
		private function onValidate(event:Event = null):void
		{
			...
			{
				InfoManager.showTimed( Localizer.getInstance().translate("LOGIN.INVALID_PASSWORD"), InfoManager.DEFAULT_DISPLAY_TIME, InfoContent.ICON_CROSS );
				return;
			}
