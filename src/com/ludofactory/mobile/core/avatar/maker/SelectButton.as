...
package com.ludofactory.mobile.core.avatar.maker
{
	 ...
	 */
	public class SelectButton extends DisplayObjectContainer
	{
		...
		public function SelectButton()
		{
			...
			_priceText = _("SELECTIONNÉ");
			
			mUpState = StarlingRoot.assets.getTexture("avatar-choice-button-background");
			mDownState = StarlingRoot.assets.getTexture("avatar-choice-button-over-background");
			mOverState = StarlingRoot.assets.getTexture("avatar-choice-button-over-background");
			mDisabledState = null;
			...
			_icon = new Image(Theme.checkIcon);
		...
		private function createTextField():void
		{
			if (mTextField == null)
			{
				mTextField = new TextField(80, upState.height, "", Theme.FONT_OSWALD, 24, 0x4a2800, true);
		...
		public function set text(value:String):void
		{
			...
			else
			{
				...
				if(_isSelected)
				{
					_icon.x = roundUp((upState.width - mTextField.width - _icon.width - 5) * 0.5);
					mTextField.x = _icon.x + _icon.width + 2;
				}
				else
				{
