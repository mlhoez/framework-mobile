...
*/
package com.ludofactory.mobile.core.navigation.tournament
{
	...
	import com.ludofactory.mobile.core.navigation.ads.tournament.AdTournamentContainer;
	import com.ludofactory.mobile.core.config.GlobalConfig;
	import com.ludofactory.mobile.core.config.GlobalConfig;
	import com.ludofactory.mobile.core.push.GameSession;
	import com.ludofactory.mobile.core.navigation.tournament.listing.RankData;
	import com.ludofactory.mobile.core.navigation.tournament.listing.RankHeaderData;
	import com.ludofactory.mobile.core.navigation.tournament.listing.RankHeaderItemRenderer;
	import com.ludofactory.mobile.core.navigation.tournament.listing.RankItemRenderer;
	import com.ludofactory.mobile.core.navigation.tournament.listing.TournamentListHeader;
		...
		private function onPlay(event:Event):void
		{
			if( MemberManager.getInstance().getTournamentUnlocked() == true )
			{
				...
				else
				{
					...
					/*if( (MemberManager.getInstance().getNumFreeGameSessions() >= Storage.getInstance().getProperty( StorageConfig.PROPERTY_NUM_FREE_IN_TOURNAMENT_MODE ))
