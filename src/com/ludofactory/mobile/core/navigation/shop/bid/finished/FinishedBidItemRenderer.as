...
*/
package com.ludofactory.mobile.core.navigation.shop.bid.finished
{
	 ...
	 */	
	public class FinishedBidItemRenderer extends FeathersControl implements IListItemRenderer
	{
		...
		public function FinishedBidItemRenderer()
		{
		...
		private var _data:FinishedBidItemData;
		...
		public function set data(value:Object):void
		{
			...
			this.touchPointID = -1;
			this._data = FinishedBidItemData(value);
			this.invalidate(INVALIDATION_FLAG_DATA);
		}
