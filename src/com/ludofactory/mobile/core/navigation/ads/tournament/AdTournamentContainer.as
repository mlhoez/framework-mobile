...
Created : 25 nov. 2013
*/
package com.ludofactory.mobile.core.navigation.ads.tournament
{
	 ...
	 */	
	public class AdTournamentContainer extends FeathersControl
	{
		/**
		 * List */		
		...
		public function AdTournamentContainer()
		{
			super();
			
			this.height = scaleAndRoundToDpi(200);
		}
		...
		override protected function initialize():void
		{
			...
			_list.itemRendererType = AdTournamentItemRenderer;
...
//------------------------------------------------------------------------------------------------------------
		...
		public function set dataProvider(val:Array):void
		{
			for(var i:int = 0; i < val.length; i++)
				val[i] = new AdTournamentData( val[i] );
			_dataProvider = val;
		}
