...
*/
package com.ludofactory.mobile.core.navigation.account.history.settings
{
	 ...
	 */	
	public class AccountMailAlert extends FeathersControl
	{
		private static const BASE_HEIGHT:int = 120;
		private var _minimumHeight:Number;
		
		private static const COLOR_FAILURE_STROKE:uint = 0xff5800;
		private static const COLOR_FAILURE_SHADOW:uint = 0xd04800;
		private static const COLOR_FAILURE:uint = 0xff5800;
		...
		public function AccountMailAlert(message:String, success:Boolean)
		{
			super();
		...
		override protected function initialize():void
		{
			...
			_icon = new Image( AbstractEntryPoint.assets.getTexture( _success ? "Check":"Danger" ) );
			...
			//_messageLabel.textRendererProperties.nativeFilters = [ new DropShadowFilter(0, 75, 0x000000, 0.75, 5, 5) ];
		}
