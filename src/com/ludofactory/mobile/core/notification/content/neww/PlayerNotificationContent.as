...
package com.ludofactory.mobile.core.notification.content.neww
{
	...
	public class PlayerNotificationContent extends AbstractPopupContent
	{
		...
		/**
		 * The yes button. */		
		private var _yesButton:MobileButton;
		...
		override protected function initialize():void
		{
			...
			_notificationTitle = new TextField(10, 100, _("Parrainer"), new TextFormat(Theme.FONT_SANSITA, scaleAndRoundToDpi(50), Theme.COLOR_DARK_GREY));
			...
			_yesButton = ButtonFactory.getButton(_("Facebook"),ButtonFactory.BLUE);
			_yesButton.addEventListener(Event.TRIGGERED, onConfirm);
			addChild(_yesButton);
			
			_cancelButton = ButtonFactory.getButton(_("E-mail"),ButtonFactory.YELLOW);
