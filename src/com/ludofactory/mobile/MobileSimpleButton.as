...
package com.ludofactory.mobile
{
	 ...
	 */
	public class MobileSimpleButton extends DisplayObjectContainer
	{
	...
	// ----------- Textures
		 ...
		 **/
		public function MobileSimpleButton(upState:Texture, text:String = "", downState:Texture = null, overState:Texture = null, disabledState:Texture = null)
		{
		...
		public function set state(value:String):void
		{
			...
			switch (mState)
			{
				case ButtonState.DOWN:
					...
					dispatchEventWith(MobileEventTypes.BUTTON_DOWN);
					break;
				case ButtonState.UP:
					setStateTexture(_upTextures);
					dispatchEventWith(MobileEventTypes.BUTTON_UP);
					break;
